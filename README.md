...
### Новое в лабораторной работе №2 (Этап 1)
#### Интерфейс
...
#### Работа анализатора
![](Screenshots/lab2_stage1_analyzer_work.png)

Пример работы анализатора на этапе 1. В таблице отображаются только пробелы, табуляции и переносы строк. Буквы и символы пока игнорируются.
