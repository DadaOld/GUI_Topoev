...
### Новое в лабораторной работе №2 (Этап 3)
#### Интерфейс
...
#### Работа анализатора
![](Screenshots/lab2_stage3_analyzer_work.png)

Пример работы анализатора на этапе 3.
...
- **Нет обработки ошибок** - неизвестные символы игнорируются без уведомления пользователя
- **Нет поддержки чисел** - цифры не воспринимаются, если перед ними нет буквы
...
- **Отсутствует навигация** - клик по строке таблицы не перемещает курсор в редакторе
